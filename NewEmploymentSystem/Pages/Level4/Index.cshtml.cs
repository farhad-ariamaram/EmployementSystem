...
namespace NewEmploymentSystem.Pages.Level4
{
    public class IndexModel : PageModel
    {
        ...
        public IEnumerable<TblWorkExperience> workExperiencesList { get; set; }
        ...
        public IActionResult OnGet()
        {
            ...
            workExperiencesList = from a in _db.TblWorkExperiences
                                  where a.UserId == uid
                                  select a;

            if (HttpContext.Session.GetString("EnterLevel4") == null)
            {
                HttpContext.Session.SetString("EnterLevel4", DateTime.Now.ToString());
            }
        ...
        public IActionResult OnPost()
        {
            ...
            if (workExperiencesList.Any())
            {
                //Time Logging
                _db.TblPageTimeLogs.Add(Utility.logTime(uid, HttpContext.Session.GetString("EnterLevel4"), "Level4"));
                _db.SaveChanges();
            ...
            TblWorkExperience t = new TblWorkExperience()
            {
                UserId = uid,
            };
            _db.TblWorkExperiences.Add(t);
            _db.SaveChanges();
